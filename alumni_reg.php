...
#main_body_right2_content{
	...
	width:260px;
	height:auto;}	
#main_body_right1_content ul{}
#main_body_right1_content li {margin-left:30px; margin-bottom:5px; margin-top:5px;}
...
<div id="header">
 	<div id="header_contain" align="right">
    	<form action="http://www.google.com/search" method="get" target="_blank">
    	  <input type="text" name="q" id="search" tabindex="1" title="Press ENTER to Search" style="background:url(images/search.jpg); border:thin rgb(71,24,0) solid; color:#d3d3d3;"/>
    	  </form>
  	    </div>
...
<table align="center"><td>
  ...
  <li><a href="">Achievements</a>
    ...
    <li><a href="dropdown/academics.html">Academics</a></li>
  ...
  <li><a href="alumni.html">Alumni</a></li>
		...
		<form method="post" action="alumni_reg_confirm.php"> 
				...
				<TR >
					<TD ><B>Full Name:</B></TD>
					<TD >
						<INPUT name=name maxLength="40" size="35" class="round" onkeypress="return event.charCode>=65 && event.charCode<=91 || event.charCode>=97 && event.charCode<=122 ||event.charCode==32 || event.charCode==46" placeholder="Your Complete Name"  value=""title="Give your full name here" required>  
					&nbsp;&nbsp;<span><font color="red">*</span></font>
					</TD>
				</TR>
			...
			<TR >
					...
					<TD >
						<select name=pyear class="round ROW1" title="Select the Year when you have passed out from the school">
				...
				<TR >
					<TD ><B>Gender:</B></TD>
					<TD >
			    <select name=gender class="round ROW1" title="gender">
				...
				<TR >
					<TD ><B>Active Email-ID:</B></TD>
					<TD >
						<input type="email" name=email maxLength="60" size="50" class="round ROW1" onkeypress="return event.charCode>=48 && event.charCode<=57 || return event.charCode>=65 && event.charCode<=91 || event.charCode>=97 && event.charCode<=122 || event.charCode==32 || event.charCode==46 || event.charCode==40 || event.charCode==95" placeholder="Your Present E-mail ID" required title="Give your Email-ID">  
					&nbsp;&nbsp;<span><font color="red">*</span></font>
					</TD>
				</TR>
				
				<TR >
					<TD ><B>Active Mobile Number:</B></TD>
					<TD >
						<INPUT name=mob maxLength="10" size="15" class="round ROW1" onkeypress="return event.charCode>=48 && event.charCode<=57" placeholder="Phone Number" required title="Give your Phone Number" > 
						&nbsp;&nbsp;<span><font color="red">*</span></font>
				...
				<TR >
					<TD ><B>What Stream had you chosen:</B></TD>
					<TD >
						
				<select name=stream class="round ROW1" title="Stream you had chosen after 12th" >
				...
				<option value="Integrated (BBA + MBA)">Integrated (BBA + MBA)</option>
				<option value="Integrated (B.Tech + MBA)">Integrated (B.Tech + MBA)</option>
				<option value="BCA">BCA</option>
				<option value="AirCraft Maintainance Engg.">Aircraft Maintainance Engg.</option>
				...
				<option value="Film Making & Production">Film Making & Production</option>
				
				
				</select>&nbsp;&nbsp;<span><font color="red">*</span></font>
				...
				<td> <INPUT name=branch maxLength="30" size="40" class="round ROW1" onkeypress="return event.charCode>=65 && event.charCode<=91 || event.charCode>=97 && event.charCode<=125 ||event.charCode==32" placeholder="Full name of your Branch" title="Name of the Branch"> (<i>optional</I>)</td>
				</tr>
				
				<tr>
				 <td>
				 <B>Full Name of the College:</B>
				</td>
				<td> <INPUT name=university maxLength="70" size="50" class="round ROW1" onkeypress="return event.charCode>=65 && event.charCode<=91 || event.charCode>=97 && event.charCode<=125 ||event.charCode==32" placeholder="Name of the Institution/University" required title="Name of the Institution/University"></td>
				</tr>
				<tr>
				<td>
				<B>Present Status:</B>
				...
				<input type="radio" name="status" value="studying">UnderGraduate &nbsp;
				<input type="radio" name="status" value="studied">Graduated &nbsp; 
				<input type="radio" name="status" value="job">Doing Job
		        ...
		        <TR>
					<TD align=center colspan='2' >
						<input type=submit value="Submit" CLASS="btn btn-small btn-primary" > and be a part of | <font color="Blue">D.A.V. Alumni Association.</font>
					</TD>
				</TR>
...
<br><br>				 
       ...
       <font color = "white" face="arial">
	     &copy; 1997 - <?php print date('Y',time()); ?>. Maintained by D.A.V. Public School, Burla, Computer Science Department .
         </div>
